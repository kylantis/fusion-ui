(function (global, factory) {
    ...
    Bezier.prototype.length = function () {
        ...
        for (let i = 0; i <= steps; i += 1) {
            ...
            const cx = this._point(t, this.startPoint.x, this.control1.x, this.control2.x, this.endPoint.x);
            // eslint-disable-next-line max-len
            // eslint-disable-next-line no-underscore-dangle
            const cy = this._point(t, this.startPoint.y, this.control1.y, this.control2.y, this.endPoint.y);
            if (i > 0) {
                const xdiff = cx - px;
                const ydiff = cy - py;
