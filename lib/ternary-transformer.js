...
class TernaryTransformer {
    ...
    parse() {
        ...
        const { T_EXPR, AND, OR } = TernaryTransformer;
        const _this = this;
        ...
        //     const conditionalBlocks = ['if', 'unless'];
        //     const conditionalOperators = [AND, OR, NOT];

        //     if (
        //         !conditionalBlocks.includes(stmt.path.original) ||
        //         stmt.params[0].type !== 'SubExpression'
        //     ) {
        //         return;
        //     }

        //     const { path, params } = stmt.params[0];

        //     const isTernary = path.or == NOT
            
        //     // params
        //     //     .filter(({ original }) => conditionalOperators.includes(original))
        //     //     .length;
        ...
        //     const expr = _this.getExpression({ stmt: stmt.path });
