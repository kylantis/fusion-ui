...
class TemplatePreprocessor {
  ...
  writeMinifiedComponentJsFile({ data, fileName }) {
    ...
    // Todo: If a component contains: console.info('\n\n\n\n'), Error: SyntaxError: Unterminated string constant
    // will be thrown - we need to find a solution - if not we may have to dump UglifyJS
