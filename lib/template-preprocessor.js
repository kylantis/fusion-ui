...
class TemplatePreprocessor {
  ...
  static getTokens({ ast }) {
    ...
    const onMustacheStatement = (stmt) => {
      ...
      const { rawDataPrefix, hasDataPathFormat } = TemplatePreprocessor;
  ...
  process0({
    ...
    ASTParser.prototype.MustacheStatement = function (stmt) {
      ...
      const { loadComponentHelperName, ternaryHelperName } = TemplatePreprocessor;


      if (stmt.path.original === ternaryHelperName && !isCustomContext()) {
