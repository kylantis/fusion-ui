...
class TemplatePreprocessor {
  ...
  static contentHelperName = 'contentHelper';
  ...
  addDataBindTransformations(ast) {
    ...
    const {
      ...
      createContentStatement, createMustacheStatement, htmlWrapperCssClassname, throwError, visitNodes
    } = TemplatePreprocessor;
    ...
    visitNodes({
      ...
      ast,
      consumer: ({ stmt }) => {
        const { contentHelperName, createStringLiteral, createPathExpression, getDefaultStripOptions, getDefaultLoc } = TemplatePreprocessor;
        const { original, loc } = stmt;
          ...
          for (const node of classInfo.templateAst.body) {
            ...
            if (!node.program.programId) {
              ...
              registerProgram({
                ...
                templateSrc: getBlockSource(classInfo.templateSrc, node),
