...
class ModelFactory {
  ...
  static getEnumSrcFiles({ baseDir }) {
  ...
  static getSharedClasses() {
    ...
    return [
      ...
      ...getEnumSrcFiles({ baseDir: getDir(pkgName) })
    ];
  }
  ...
  /**
   * This returns the path where java files should be writter to.
  ...
  static quicktypeJSONSchema({
    ...
    const sharedClasses = getSharedClasses();
