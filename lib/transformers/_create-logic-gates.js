                            ...
                            if (!this.preprocessor.methodNames.includes(stmt.original)) {
                                ...
                                switch (true) {
                                    case stmt[conditionalKey]:
                                        ...
                                        // We want to indicate that <stmt> is specifically a condition expression
                                        // in a logicGate. This is because <PARTICIPANT_TYPE_CONDITIONAL> is generally
                                        // used broadly, i.e. for  path expressions suffixed with "?"
                                        stmt.isLogicGateCondition = true;
    ...
    explodeTernaryEachBlocks() {
        ...
        ASTParser.prototype.BlockStatement = function (stmt) {
            ...
            if (stmt.path.original == 'each' && stmt.params[0] == T_EXPR) {
                ...
                ASTParser.prototype.BlockStatement.call(this, stmt);
