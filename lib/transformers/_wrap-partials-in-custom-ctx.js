...
class PartialTransformer {
    ...
    transform() {
        ...
        const {
            logger,
            constructor: { 
                noOpHelperName, createPathExpression, getDefaultStripOptions,  getHandleBarsBlockHelpers, 
                getLine, createHtmlWrapperHashKey, createBooleanLiteral,
            },
        } = this.preprocessor;
            ...
            if (
                ...
                return {
                    ...
                    hash: {
                        type: 'Hash',
                        pairs: [
                            ...Object.entries(nonLiteralHashes)
                            .map(([key, value]) => ({
                                type: 'HashPair', key, value,
                            })),
                            {
                                type: 'HashPair', 
                                key: createHtmlWrapperHashKey,
                                value: createBooleanLiteral(false),
                            }
                        ]
                    },
                    program: {
