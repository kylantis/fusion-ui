...
class PathResolver {
  ...
  constructor({ srcDir, componentName }) {
  ...
  getRawValue({ original }) {
    return this.data[original] ? this.getWrappedValue(this.data[original].clone()) : null;
  }
